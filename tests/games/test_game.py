...
class TestGame(unittest.TestCase):
    ...
    @patch("games.abstracts.game.Game.start_game_settings", return_value=None)
    @patch("games.abstracts.game.Game.start_game", return_value=True)
    def test_play_won(self, mock_start_game, mock_game_settings):
        self.assertTrue(self.game.play())

    @patch("games.abstracts.game.Game.start_game_settings", return_value=None)
    @patch("games.abstracts.game.Game.start_game", return_value=False)
